...
int main() {
	...
	// Maybe you will have to modify the path if restricted by your machine
	...
	//Sorter::QuickSort((IComparable**)people, maxPeople);
	...
	// Check the output on the screen. If 'Person' objects are sorted in ascending order, the Task 2 is done successfully.
	return 0;
}